/* River Raid - Hall of Fame leaderboard (Cloudflare Worker + KV)
 *
 * Endpoints
 *   GET  /scores                 -> { scores: [ {name, score, ts}, ... up to 25 ] }
 *   POST /scores  {name, score}  -> validates, stores, returns the new top list
 *
...
const MAX_SCORE = 5000000; // sane upper bound for one run
